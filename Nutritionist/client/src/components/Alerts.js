...
export class Alerts extends Component {
  ...
  componentDidUpdate(prevProps) {
    ...
    if (message !== prevProps.message) {
      ...
      if (message.maxcalRequired) {
        alert.info(message.maxcalRequired);
      }
      if (message.mincalRequired) {
        alert.info(message.mincalRequired);
      }
      if (message.tokenRequired) {
        alert.info(message.tokenRequired);
      }
